...
-- Drop existing model DB (optional)
-- DROP DATABASE IF EXISTS :modeldbname;
...
-- Connect to the new model database
\connect :modeldbname
set role dba_team;
-- Load schema
--
...
-- ✅ model template created successfully
