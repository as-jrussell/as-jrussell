...
$sqlScriptPath = "C:/GitHub/as-jrussell/Opscenter/Administry_Of_Databases/Postgres/Postgres_Deploy/000_setup_no_DBA_permissions.sql"
$tempSqlPath = "$env:TEMP\temp_no_dba_setup.sql"
