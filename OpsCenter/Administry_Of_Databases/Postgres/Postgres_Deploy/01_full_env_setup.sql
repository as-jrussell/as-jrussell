...
-- 🔹 01 CreateAccounts (from 1.sql)
-- -------------------------------------------------------------
DO $$
BEGIN
    RAISE NOTICE '▶ STARTING STEP: 01 CreateAccounts';
...
END
$$;
    RAISE NOTICE '✅ PASS: 01 CreateAccounts';
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE '❌ FAIL: 01 CreateAccounts - %', SQLERRM;
END $$;

-- 🔹 02 CreateDatabase (from 2.sql)
-- -------------------------------------------------------------
DO $$
BEGIN
    RAISE NOTICE '▶ STARTING STEP: 02 CreateDatabase';
CREATE DATABASE "DBA"
    WITH
    OWNER = dbadmin
    ENCODING = 'UTF8'
...
GRANT ALL ON DATABASE "DBA" TO dbadmin;
    RAISE NOTICE '✅ PASS: 02 CreateDatabase';
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE '❌ FAIL: 02 CreateDatabase - %', SQLERRM;
END $$;

-- 🔹 03 DelegatePermissions (from 3.sql)
-- -------------------------------------------------------------
DO $$
BEGIN
    RAISE NOTICE '▶ STARTING STEP: 03 DelegatePermissions';
...
ELSE
    ...
    RAISE NOTICE '✅ PASS: 03 DelegatePermissions';
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE '❌ FAIL: 03 DelegatePermissions - %', SQLERRM;
END $$;

-- 🔹 04 CreateTables (from 4.sql)
-- -------------------------------------------------------------
DO $$
BEGIN
    RAISE NOTICE '▶ STARTING STEP: 04 CreateTables';
-- ================================================================
...
END
$$;
    RAISE NOTICE '✅ PASS: 04 CreateTables';
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE '❌ FAIL: 04 CreateTables - %', SQLERRM;
END $$;
